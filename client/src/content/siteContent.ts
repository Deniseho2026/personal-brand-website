...
export const siteCopy = {
  ...
  studioLabel: { en: "A quiet studio for reflection", zh: "一個安靜的反思空間" },
  closing: {
...
export const journey = [
  { year: "01", title: { en: "Banking", zh: "銀行業" }, body: { en: "A formative early career that taught me about responsibility, people, and the outer structures of life.", zh: "早年的職涯讓我學習責任、人與人之間的相處，以及外在生活的結構。" } },
  ...
  { year: "04", title: { en: "Painting & writing", zh: "繪畫與寫作" }, body: { en: "A continuing practice of attention, reflection, and companionship with the inner and outer worlds.", zh: "一種持續的練習：專注、反思，並陪伴內在與外在世界相遇。" } },
];
